import { Component, OnInit, signal, AfterViewInit, ViewChild, ElementRef, ChangeDetectorRef, SecurityContext } from '@angular/core';
...
export class EmailEditorComponent implements OnInit, AfterViewInit {
  ...
  setupQuill() {
    if (this.quill || !this.editorContainer) return;
