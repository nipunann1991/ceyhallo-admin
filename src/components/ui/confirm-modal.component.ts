      ...
      <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md sm:w-full">
          ...
          <div class="bg-slate-50 px-4 py-3 flex justify-end gap-2">
            <button (click)="confirm.emit()" type="button" class="inline-flex justify-center rounded-lg border border-transparent px-3 py-1.5 bg-red-600 text-sm font-medium text-white hover:bg-red-700">
              Delete
            </button>
